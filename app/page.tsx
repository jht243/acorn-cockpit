              ...
              <ul>
                {upcoming.map((u) => (
                  <li key={u.id} className="px-5 py-3 border-t flex items-center justify-between" style={{ borderColor: "var(--line)" }}>
                    <div>
                      <Link href={`/clients/${u.id}`} className="font-medium text-sm hover:underline">{u.name}</Link>
            ...
            <div className="col-span-12 lg:col-span-5 card">
              ...
              <div className="card-pad">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div className="text-sm">Send Roth conversion analysis to <Link href="/clients/anita" className="font-medium hover:underline">Anita</Link>.</div>
                </div>
                <div className="flex items-start gap-3 mb-3">
                  <span className="pill pill-amber">In 4 days</span>
                  <div className="text-sm">Refer <Link href="/clients/anita" className="font-medium hover:underline">Anita</Link> to estate attorney.</div>
                </div>
                <div className="flex items-start gap-3 mb-3">
                  <span className="pill pill-amber">Next week</span>
                  <div className="text-sm">Schedule Q1 check-in with <Link href="/clients/ryan" className="font-medium hover:underline">Dr. Ryan & Chere</Link>.</div>
                </div>
