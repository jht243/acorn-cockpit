...
const items = [
  ...
  { href: "/dashboard/professional-network", label: "Professional Network", icon: NetworkIcon },
];
...
function NetworkIcon() { return <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="5" r="2"/><circle cx="5" cy="19" r="2"/><circle cx="19" cy="19" r="2"/><path d="M12 7v4m0 0-5 6m5-6 5 6"/></svg>; }
